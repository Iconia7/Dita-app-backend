...
urlpatterns = [
    ...
    path('request-sms-otp/', views.request_sms_otp, name='request-sms-otp'),
    path('reset-password-with-otp/', views.reset_password_with_otp, name='reset-password-with-otp'),
